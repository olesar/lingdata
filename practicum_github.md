...
<img src="https://www.develer.com/wp-content/uploads/2021/08/image-9.png" alt="branches" width="70%"/>
...
<img src="fig/github-branches.png" alt="branches" width="70%"/>  
...
Напишите в нем любой текст и сохраните изменения -- `Commit changes...` (внизу страницы). При коммите полезно описывать в специальном поле, какие изменения вы внесли и почему.  

Посмотрите, что изменилось в структуре репозитория и в истории изменений.  
...
Вы можете переключаться между режимами `Code` и `Preview`, чтобы увидеть визуальные эффекты форматирования.
