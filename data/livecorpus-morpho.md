...
Схема морфологической разметки задается ограниченным инвентарем помет (тегов). В LiveCorpus используется вариант схемы UD-ext (Universal Dependencies extended)[https://universaldependencies.org/ru/pos/] на основе инвентаря, принятого в международном проекте Универсальных зависимых и совместимого с пометами НКРЯ. 
