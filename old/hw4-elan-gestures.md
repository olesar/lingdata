...
* микропаузы внутри реплик (слои _pause@_...)  (пустыми аннотоциями надо выделить временные промежутки между аннотациями с текстом и промежутки с паузами внутри текста (там, где /))
