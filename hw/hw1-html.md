...
Создайте свою личную страницу с именем, фотографией и сведениями о вас. На основе ваших личных страничек мы сделаем сайт вашего курса и отправим его в закрытую рассылку Школы лингвистики, чтобы преподаватели могли с вами познакомиться. 

*Важно! То, что вы кладёте на гитхаб в публичный репозиторий, становится доступным  для всех, у кого есть Интернет. Поэтому не стоит писать то, что вам хотелось бы хранить в секрете (например, где лежит ключ от квартиры, пароли, личный номер и т.д.).*
...
* Если вы имееете большой опыт в создании страниц и сайтов, вы можете загрузить авторский вариант страницы, сделанный "с нуля". 
...
* содержание страницы -- напишите про себя что-то интересное и нетривиальное (одного абзаца недостаточно!)
...
* не стирайте шапку файла с гиперссылкой на сайт Школы лингвистики и на страницы курса и группы (поправьте номер группы)
...
* С помощью тега `<a href="...` добавьте гиперссылки на ваши страницы в соцсетях, на гитхабе, на другие личные страницы, если это не секрет. Если секрет - добавьте ссылки на что-нибудь другое.
...
* Если вы хотите добавить дополнительные картинки, найдите тег <img> на html-странице и замените URL изображения на название файла. Вы можете также дать ссылку на картинку, выложенную в сети Интернет, но имейте в виду, что в будущем ваша ссылка легко может оказаться "битой". Гораздо надёжнее положить нужные вам фотографии на гитхаб.  
...
* Проверьте, что в вашем репозитории одна ветка и она называется `gh-pages`. Если нет, нужно исправить.  
...
На страничке обязательно должны быть ваши имя с фамилией, фотография, родной город, школа, ссылки на соцсети (или ссылки на что-то другое). Нужно воспроизвести на вашей самодельной странице гиперссылки на сайт Школы лингвистики и сайты групп (см. меню мастер-файла html), чтобы с вашей личной страницы можно было переходить к другим страницам.   

Очень желателен адаптивный дизайн, чтобы на устройствах с небольшим экраном заголовки не отрывались от текста, а подписи от фотографий.

Мы не против использования ИИ, но важно, чтобы вы понимали, что происходит в вашем коде. Мы можем попросить вас поправить код страницы в классе, чтобы убедиться, что вы разбираетесь в написанном.
