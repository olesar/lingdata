## ДЗ 2,5. "Разработка фрагмента учебного корпуса", часть 0
...
Что записываем: спонтанную речь и диалог.
1. Попросите рассказать про любимую игрушку в детстве, семейную традицию, запомнившуюся поездку и т.д. Придумайте нестандартную речевую активность для информанта, попросите объяснить, как добраться от одного места до другого (от школы информанта до дома), как играть в настольную игру (не самую его любимую, чтобы это не было заученным текстом), спросите, как человек будет действовать в гипотетической ситуации, можно задавать неочевидные вопросы о жизни и т.д.
2. В диалоге спросите что-то про прошлое и что-то про будущее. 

#### Выбор фрагмента для разметки

В ходе проекта вам предстоит разметить 5 минут видео. (В домашних заданиях от вас требуется разметка только минуты из 5 минут.)
...
Выберите в паре два фрагмента по 5 минут. Они не обязательно должны идти подряд. Фрагменты должны быть разные, не пересекаться.
...
***Не режьте видео! Работайте с целиковым!***

#### Файлохранилище
Файлы должны быть названы в формате `Irkutsk_jms2005.mp4`, где первая часть - название города/региона информанта (Saint-Petersburg, NizhnyNovgorod), затем идут инициалы информанта (например, _jms_ для _Юлия Михайловна Щепкина_) и его год рождения.
Положите файл в [папку](https://drive.google.com/drive/folders/1LPCmGN16lVl4PmJ8YkNKkRwg42ODva6w?usp=sharing) и дайте ссылку на него [в таблице](https://docs.google.com/spreadsheets/d/1abcEfFIUWz1ndhxgMyzuYNR9xJJ1r4p5wSGxxdLUey4/edit?usp=sharing), заполнив поля с метаинформацией. Если запись по каким-то причинам разбилась на несколько файлов, соедините их. (Не рекомендуется выкладывать медиафайлы на GitHub, так как он не предназначен для хранения объемных данных.)
...
\- А можно мы в зуме созвонимся и запишем?
- Нет, нужно вживую. Говорение перед экраном компьютера  - немного другой жанр. Жестикуляции скорее всего будет меньше (или другая), качество записи хуже и т.д.

\- Нашей паре совсем неудобно состыковываться по времени. Что делать?
...
Хороший пример. Руки будут видны и в сложенном виде. Информанту удобно, однако есть вероятность, что стол скроет небольшую часть движений.
