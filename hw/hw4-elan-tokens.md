...
- При необходимости поправьте разметку минуты из прошлого дз
``` 
* Название слоя - `text@aaa1970f` (на каждого говорящего по слою)
* Тип - utterance  
Обязательно заполните пункты "говорящий" (@aaa1970f) и "разметчик".
```
...
Значение тегов можно посмотреть [в руководстве](https://github.com/olesar/lingdata/blob/gh-pages/data/livecorpus-morpho.md).
