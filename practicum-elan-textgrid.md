...
Для тренировки можно воспользоваться .eaf [файлом](https://github.com/olesar/lingdata/blob/gh-pages/data/hobgoblin13_justtext.eaf) с готовым слоем `text` и [видео](https://disk.yandex.ru/i/_ayO0y21p2TI-Q) к нему.
