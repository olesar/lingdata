...
* `gestType@aaa1989f` - для разметки типа жеста (тип `gesture_type`, слой не имеет родителя, стереотип - None)
* `gestMeaning@aaa1989f` - для разметки значения жеста (тип `gesture_meaning`, родительский слой - gestType@...)
* `gestBody@aaa1989f`, тип `gesture_organ`s, родительский слой - gestType@..., стереотип - Included In
...
Аккуратное выполнение с соблюдением всех требований оценивается на 8. В проекте задания на 9 и 10 выполняются в инициативном порядке.
