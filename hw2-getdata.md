...
2. *Ответы на вопросы* (10 минут) 
3. *Назови картинку* (5 минут)   
...
На вкладке [Рандом]() вы найдете столбец Картинка. В [облаке](https://disk.yandex.ru/d/If99Q01jEIJMBA) найдите назначенную вам как интервьюеру папку и покажите информанту, в среднем темпе, картинки по очереди. Информант, увидев картинку, должен назвать изображенный на картинке предмет (1 раз).
